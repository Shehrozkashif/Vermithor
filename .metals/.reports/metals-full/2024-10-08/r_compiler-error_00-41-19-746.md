file://<HOME>/Desktop/New%20Folder%203/Vermithor/src/main/scala/core/Pipelines/reg1.scala
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2FPipelines%2Freg1.scala:13: error: illegal start of simple pattern
        val              = Output (UInt(32.W))        // PC + 4 out
                         ^
...
class IF_ID extends Module {
    val io = IO(new Bundle {
        ...
        val instruction_reg1_out              = Output (SInt(32.W))        // PC out
        val              = Output (UInt(32.W))        // PC + 4 out
