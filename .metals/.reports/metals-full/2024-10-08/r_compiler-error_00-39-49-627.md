...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2FPipelines%2Freg1.scala:9: error: illegal start of simple pattern
        val               = Input (UInt(32.W))         // PC4 in
                          ^
...
class IF_ID extends Module {
    val io = IO(new Bundle {
        val instruction               = Input (SInt(32.W))         // PC in
        val               = Input (UInt(32.W))         // PC4 in
