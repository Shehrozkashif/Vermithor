...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ffetch.scala:90: error: `identifier` expected but `}` found
}
^
...
val io = IO(new Bundle{
    ...
    val Imem_fetch_data_in = Input(UInt(32.W))
    ...
    pcmod.io.out := io.pc_fetch_out


     // connections between instruction and fetch_module inputs
    inmmod.io.enable := Imem_fetch_enable
    inmmod.io.address := Imem_fetch_address
    inmmod.io.
