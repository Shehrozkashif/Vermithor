...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Ftest%2Fscala%2Fcore%2Ffetchtest.scala:10: error: `identifier` expected but `)` found
    a.io.pc_fetch_jump.poke(0.)
                              ^
...
"Chisel Tester fetch test" in {
    ...
    a.io.pc_fetch_jump.poke(0.)
    a.io.pc_fetch_jump2.poke(0.B) 
    a.io.pc_fetch_jump3.poke(0.B)  


    a.io.Imem_fetch_enable.poke(1.B) 
    a.io.Imem_fetch_address.poke(1.U) 
    a.io.Imem_fetch_out.poke(1.U) 
