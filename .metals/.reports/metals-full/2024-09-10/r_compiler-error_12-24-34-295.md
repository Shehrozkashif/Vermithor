...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Ftest%2Fscala%2Fcore%2Ffetchtest.scala:12: error: `identifier` expected but `)` found
    a.io.pc_fetch_jump3.poke(0.)  
                               ^
...
"Chisel Tester fetch test" in {
    ...
    a.io.Imem_fetch_enable.poke(1.U) 
