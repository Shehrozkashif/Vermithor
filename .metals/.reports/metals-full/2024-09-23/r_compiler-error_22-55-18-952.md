...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ftop_core.scala:28: error: `identifier` expected but `}` found
}
^
...
class top_core extends  Module {
  ...
  val wb_module = Module(new wb)
    ...
    execute_module.io.op_alu_execute := decode_module.io.
