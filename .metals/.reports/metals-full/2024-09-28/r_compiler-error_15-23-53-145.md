...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Fexecute.scala:51: error: `;` expected but `.` found
    io.pc_imm_added  :=  io. + io.pc_fetch
                                 ^
...
val io = IO(new Bundle{
    ...
    when(io.ins_execute (6,0) === "h13".U || io.ins_execute (6,0) === "h23".U || io.ins_execute(6,0) === "h3".U || ){ // if I type instruction
