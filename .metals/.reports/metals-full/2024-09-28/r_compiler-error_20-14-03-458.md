...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ffetch.scala:26: error: `identifier` expected but `)` found
    val inmmod = Module(new )
                            ^
...
val io = IO(new Bundle{
  ...
  inmmod.io.data_in := 0.U
  inmmod.io.enable := true.B
