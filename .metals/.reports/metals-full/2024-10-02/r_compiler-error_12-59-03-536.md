...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ftopcore.scala:92: error: `identifier` expected but `}` found
    }
    ^
...
class topcore extends  Module {
  ...
  val wb_module = Module(new wb)
    ...
    regfmod.io.wdata := decode_module.io.decode_imm_out + fetch_module.io.
