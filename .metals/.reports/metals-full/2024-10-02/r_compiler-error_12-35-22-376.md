...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ftopcore.scala:87: error: `identifier` expected but `}` found
    }
    ^
...
class topcore extends  Module {
  ...
  val wb_module = Module(new wb)
    ...
    decode_module.io.decode_regf_wdata := decode_module.io.
    }
