...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ffetch.scala:61: error: `identifier` expected but `}` found
}
^
...
val io = IO(new Bundle{
    ...
    val pc_imm_decode_to_fetch_out = Input(UInt(32.W))
    ...
    pcmod.io.imm := io.pc_imm_decode_to_fetch_out
   when(io.Imem_fetch_out(6, 0) === 99.U || io.Imem_fetch_out(6, 0) === "h6f".U) {
