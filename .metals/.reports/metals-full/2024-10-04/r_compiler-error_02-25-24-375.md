...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ftopcore.scala:147: error: illegal start of simple expression
    mem_module.io.ecode_regf_wdata := wb_module.io.wb_dataout(,0)
                                                              ^
 ...
 mem_module.io.wr_enable_mem  := 1.B
  ...
  mem_module.io.rd_enable_mem := 1.B
    when(decode_module.io.decode_instruction(14,12) === "b000".U ){ // load byte
      ...
      mem_module.io.ecode_regf_wdata := wb_module.io.wb_dataout(7,0)
    

    }.elsewhen(cumod.io.instruction(14,12) === "b001".U ){ // load half
            
           mem_module.io.ecode_regf_wdata := wb_module.io.wb_dataout(15,0)



    }.elsewhen(cumod.io.instruction(14,12) === "b010".U ){ // load word
     mem_module.io.ecode_regf_wdata := wb_module.io.wb_dataout(31,0)
