...
### file%3A%2F%2F%2Fhome%2Fshehroz%2FDesktop%2FNew%2520Folder%25203%2FVermithor%2Fsrc%2Fmain%2Fscala%2Fcore%2Ftopcore.scala:100: error: `;` expected but `integer constant` found
 mem_module.io. := 1.B
                   ^
...
when(decode_module.io.decode_instruction(6,0) === "h23".U ){
 ...
 mem_module.io. := 1.B
  ...
  mem_module.io.addr_mem := alumod.io.out(9,2)
